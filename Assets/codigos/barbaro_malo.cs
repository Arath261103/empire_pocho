...
public class BarbaroMalo : PersonajeBase, IVida

{
    ...
    {
        tipoPersonaje = TipoPersonajeJugador.Barbaro;
        saludMaxima = 120;
        base.Start();
    ...
    void BuscarObjetivos()
    {
        ...
        {
            if (objetivo.CompareTag("Player") || objetivo.CompareTag("Edificio1") ||
                objetivo.CompareTag("Edificio2") || objetivo.CompareTag("Edificio3") ||
    ...
    IEnumerator EmbestidaConRetroceso()
    {
        ...
        if (objetivoActual != null)
        {
            ...
            else if (objetivoActual.CompareTag("Edificio1") || objetivoActual.CompareTag("Edificio2") ||
                     objetivoActual.CompareTag("Edificio3") || objetivoActual.CompareTag("Granja"))
            {
