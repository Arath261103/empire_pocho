...
public class Espadachin : PersonajeBase,IVida
{
    ...
    void InfligirDaño(PersonajeBase enemigo)
    {
        if (enemigo != null)
        {
            ...
            if (tipoEnemigo == "arquero_malo" || tipoEnemigo == "torre_arquero_malo") daño = 25;
            else if (tipoEnemigo == "barbaro_malo" || tipoEnemigo == "torre_barbaro_malo") daño = 15;
            else if (tipoEnemigo == "espadachin_malo" || tipoEnemigo == "torre_espadachin_malo") daño = 20;
        ...
        else if (enemigoObjetivo.CompareTag("flor_malvada"))
        {
            ...
            if (flor != null)
            {
                flor.RecibirDaño(30); // Ajusta el daño si lo deseas
            }
        }
    }
